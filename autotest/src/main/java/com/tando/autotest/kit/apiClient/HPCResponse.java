...
public class HPCResponse
{
  ...
  public HPCResponse(HttpResponse response)
  {
   ...
   *         {@link HPCResponse}
   */
  public HPCResponse assertStatus(int status)
  {
   ...
   *         {@link HPCResponse}
   */
  public HPCResponse assertContentType(String type)
  {
   ...
   *         {@link HPCResponse}
   */
  public HPCResponse assertHeader(String headerName, String headerValue)
  {
   ...
   *         {@link HPCResponse}
   */
  public HPCResponse assertBody(String expectedBody) throws IOException
  {
